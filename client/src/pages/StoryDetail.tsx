...
export default function StoryDetail() {
  ...
  return <div className="story-detail" style={{ fontFamily: SANS, background: page.page.backgroundColor, color: page.page.textColor }}>
    ...
    <main>
      ...
      <section style={{ background: page.inside.backgroundColor, padding: 'clamp(85px,10vw,145px) 0' }}><div className="magazine-sheet"><div className="magazine-collage"><img className="one" src={page.inside.images[0]} alt={`A detail from ${page.meta.location}`} style={{ objectFit: 'cover', display: 'block', objectPosition: getObjectPosition(page.inside.images[0]) }} /><img className="two" src={page.inside.images[1]} alt={`Life around ${page.meta.location}`} style={{ objectFit: 'cover', display: 'block', objectPosition: getObjectPosition(page.inside.images[1]) }} /></div><div className="magazine-copy"><p className="eyebrow" style={{ color: page.page.accentColor, margin: '0 0 22px' }}>{page.inside.eyebrow}</p><h2 className="display" style={{ fontSize: 'clamp(48px,6vw,82px)', margin: '0 0 38px' }}>{page.inside.title}</h2><div className="magazine-columns"><p style={{ fontSize: 18, lineHeight: 1.78, letterSpacing: '.025em', margin: 0 }}>{page.inside.context}</p><p style={{ fontSize: 18, lineHeight: 1.78, letterSpacing: '.025em', margin: 0 }}>{page.inside.body}</p></div></div></div></section>
