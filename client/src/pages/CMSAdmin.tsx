    ...
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage all Wayseek content</p>
        </div>
          ...
          <TabsContent value="stories" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage travel stories ({stories.length})</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {stories.map((story) => (
          ...
          <TabsContent value="videos" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage videos ({videos.length})</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {videos.map((video) => (
                    <div key={video.id} className="flex items-center justify-between p-3 border rounded">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{video.slug}</p>
                      </div>
                      <Button variant="outline" size="sm">Edit</Button>
                    </div>
                  ))}
