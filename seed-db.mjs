...
await connection.execute('DELETE FROM experience_types');
await connection.execute('DELETE FROM itineraries');
...
const teamData = [
  {
    name: 'Sarah Chen',
    role: 'Founder & CEO',
    bio1: 'Sarah founded the company with a passion for authentic travel experiences.',
